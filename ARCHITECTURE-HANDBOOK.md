...
Current status is Platform Service Candidate, Contract Proposed, Locally Implemented, Locally Verified, Not Deployed, and Production Use Not Allowed. Verification is limited to deterministic local adapters and isolated Local D1. No Remote D1, Cloudflare Rate Limiting API, Durable Object, Queue, Cron, provider credential, Binding, deployment, or Production verification exists.