...
本 Physical Proposal 只批准 storage envelope：`TEXT opaque internal ID`。Runtime Phase 1 的 ADR-013 已由 Tony 核准 UUIDv7；generator library、長度驗證與 conformance evidence 仍未實作、未驗證。
