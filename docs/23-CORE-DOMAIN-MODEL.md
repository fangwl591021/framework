...
Runtime Phase 1 的 Core Entity ID 選定 UUIDv7 Proposal，由 Application／Domain Service 產生；Repository、D1 與 External Identity 不產生 Domain ID。正式狀態見 [Decision Closure](runtime-phase-1/00-DECISION-CLOSURE.md)。
