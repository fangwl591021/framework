...
## Runtime Phase 1 Accepted ADR

| ADR | Decision | Status | Implementation | Verification |
| --- | --- | --- | --- | --- |
| [ADR-013](../adr/ADR-013-UUIDV7-CORE-ENTITY-IDS.md) | UUIDv7 Core Entity IDs | Accepted | Not Implemented | Not Verified |
| [ADR-014](../adr/ADR-014-EXTERNAL-IDENTITY-SUBJECT-DIGEST.md) | Versioned HMAC External Identity Digest | Accepted | Not Implemented | Not Verified |
| [ADR-015](../adr/ADR-015-TENANT-CONTEXT-INTERNAL-ADMIN.md) | Trusted Tenant Context and Internal Administration | Accepted | Not Implemented | Not Verified |
| [ADR-016](../adr/ADR-016-PHASE-1-AUDIT-IDEMPOTENCY.md) | Phase 1 Audit and Idempotency | Accepted | Not Implemented | Not Verified |
| [ADR-017](../adr/ADR-017-PHASE-1-LIFECYCLE-AUTHORIZATION-VOCABULARY.md) | Phase 1 Lifecycle and Authorization Vocabulary | Accepted | Not Implemented | Not Verified |

ADR-013～ADR-017 已由 Tony 核准；它們擴充但不改寫 ADR-001～ADR-012 的歷史與 Accepted 狀態。
...
Audit／Idempotency 已由 ADR-016 與 Approved Core Operations Contract 納入 Runtime Phase 1；Lifecycle 仍為 Candidate，未晉升 Core Approved、未 Implemented、未 Verified。

## Runtime Phase 1 Modules

| Module | Lifecycle | Contract | Implementation | Verification | Registry |
| --- | --- | --- | --- | --- | --- |
| Identity Core | Candidate | Approved by Tony | Not Implemented | Not Verified | [Registry](../registry/identity-core.md) |
| Tenant Access | Candidate | Approved by Tony | Not Implemented | Not Verified | [Registry](../registry/tenant-access.md) |
| Authorization | Candidate | Approved by Tony | Not Implemented | Not Verified | [Registry](../registry/authorization.md) |
| Core Operations | Candidate | Approved by Tony | Not Implemented | Not Verified | [Registry](../registry/core-operations.md) |
