...
| Metadata | Value |
| --- | --- |
| `module_id` | `platform-traffic-protection` |
...
| `dependencies` | Runtime Foundation, Tenant boundary, Module Gate, Authorization, Audit, Idempotency, Observability, D1 |
| `documentation_path` | `docs/platform-traffic/README.md` |
| `production_use` | Not Allowed |

Local adapters and migration verification are not production infrastructure.