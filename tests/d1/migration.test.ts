...
const expectedTables = [
  ...
  "channel_accounts",
  "channel_catalog",
  "channel_delivery_evidence",
  "channel_delivery_records",
  "channel_identity_links",
  "channel_inbound_events",
  "channel_response_policies",
...
const expectedIndexes = [
  ...
  "idx_channel_accounts_adapter_status",
  "idx_channel_accounts_tenant_app_status",
  "idx_channel_catalog_type_status",
  "idx_channel_delivery_processing_lease",
  "idx_channel_delivery_tenant_time",
  "idx_channel_event_dedup",
  "idx_channel_events_tenant_time",
  "idx_channel_evidence_support_code",
  "idx_channel_evidence_tenant_date",
  "idx_channel_identity_digest",
  "idx_channel_identity_tenant_member",
  "idx_channel_response_policy_active",
...
const expectedTriggers = [
  ...
  "trg_channel_account_no_delete",
  "trg_channel_account_terminal_guard",
  "trg_channel_account_version_guard",
  "trg_channel_catalog_no_delete",
  "trg_channel_catalog_no_update",
  "trg_channel_delivery_no_delete",
  "trg_channel_delivery_update_guard",
  "trg_channel_evidence_guard",
  "trg_channel_evidence_no_delete",
  "trg_channel_evidence_no_update",
  "trg_channel_identity_insert_guard",
  "trg_channel_identity_no_delete",
  "trg_channel_identity_terminal_guard",
  "trg_channel_identity_version_guard",
  "trg_channel_inbound_no_delete",
  "trg_channel_inbound_no_update",
  "trg_channel_response_policy_no_delete",
  "trg_channel_response_policy_no_update",
...
describe("Phase 1 local D1 migration", () => {
  ...
  it("is repeat-safe through the D1 migration ledger", async () => {
    ...
    expect(counts.map((row) => row?.count)).toEqual([85, 3, 10]);
  });
